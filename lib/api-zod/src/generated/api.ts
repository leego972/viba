...
export const ListSessionsResponseItem = zod.object({
  ...
  repoUrl: zod
    .string()
    .nullish()
    .describe("Git repository URL connected to this session (optional)"),
  repoBranch: zod
    .string()
    .nullish()
    .describe("Target branch — defaults to main when not specified"),
  workspaceEnv: zod
    .string()
    .nullish()
    .describe("Environment label: development | staging | production"),
...
export const CreateSessionBody = zod.object({
  ...
  repoBranch: zod
    .string()
    .optional()
    .describe("Branch to target — defaults to main if not specified"),
  workspaceEnv: zod
    .string()
    .optional()
    .describe("Environment label: development | staging | production"),
...
export const GetSessionResponse = zod.object({
  ...
  messages: zod.array(
    zod.object({
      ...
      messageType: zod
        .enum(["output", "question", "answer", "handoff", "context"])
        .describe(
        ...
        .array(
          zod.union([
            ...
            zod.object({
              ...
              operation: zod
                .string()
                .describe("e.g. commit, push, merge, clone"),
              branch: zod.string(),
...
export const UpdateSessionBody = zod.object({
  repoUrl: zod
    .string()
    .nullish()
    .describe("Git repository URL (null clears it)"),
