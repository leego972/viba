 ...
 */
export const getAnswerQuestionUrl = (id: number, messageId: number) => {
...
export const workbenchHealth = async (
  options?: RequestInit,
...
export const getWorkbenchHealthQueryOptions = <
  TData = Awaited<ReturnType<typeof workbenchHealth>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof workbenchHealth>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof workbenchHealth>>> = ({
    signal,
  }) => workbenchHealth({ signal, ...requestOptions });
...
export type WorkbenchHealthQueryResult = NonNullable<
  Awaited<ReturnType<typeof workbenchHealth>>
>;
...
export const workbenchAnalyze = async (
...
export const getWorkbenchAnalyzeMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type WorkbenchAnalyzeMutationResult = NonNullable<
  Awaited<ReturnType<typeof workbenchAnalyze>>
>;
 ...
 * @summary Analyze a task with the AI workbench
 */
export const useWorkbenchAnalyze = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const getGetGithubRepoUrl = (params: GetGithubRepoParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/github/repo?${stringifiedParams}`
    : `/api/github/repo`;
};

export const getGithubRepo = async (
  params: GetGithubRepoParams,
  options?: RequestInit,
): Promise<GithubRepo> => {
...
export const getGetGithubRepoQueryKey = (params?: GetGithubRepoParams) => {
  return [`/api/github/repo`, ...(params ? [params] : [])] as const;
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getGithubRepo>>> = ({
    signal,
  }) => getGithubRepo(params, { signal, ...requestOptions });
