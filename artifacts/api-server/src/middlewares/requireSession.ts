...
const EMBED_BYPASS_PATHS = new Set(["/stats", "/circuit-status"]);

/**
 * Require a valid, active and verified user session.
 * The Archibald embed bypass is restricted to explicitly read-only endpoints.
 */
