...
import taskIntakeApiAuthRouter from "./taskIntakeApiAuth";
import taskIntakeStatusRouter from "./taskIntakeStatus";
...
router.use(taskIntakeApiAuthRouter);
router.use(taskIntakeStatusRouter);
