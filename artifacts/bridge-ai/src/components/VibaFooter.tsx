...
export default function VibaFooter() {
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              {emailReady ? <a href={`mailto:${companyEmail}`} className="mt-1 block text-sm text-white/75 hover:text-teal-300">{companyEmail}</a> : <p className="mt-1 text-sm text-white/45">{companyEmail}</p>}
            </div>
            <div>
