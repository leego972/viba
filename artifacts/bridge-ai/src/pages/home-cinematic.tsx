...
export default function CinematicHome() {
  ...
  return (
    <div className="viba-cinematic-page viba-concise-home">
      ...
      <footer className="viba-cinematic-footer"><div className="viba-brand-lockup"><img src={`${import.meta.env.BASE_URL}viba-brain-logo.svg`} alt="VIBA" width={44} height={44} /><div><strong>V.I.B.A.</strong><span>ALL AS ONE</span></div></div><p>AI orchestration for production-ready software.</p><div style={{ display: "flex", alignItems: "center", gap: 8, color: "#687086", fontSize: 11 }}><span>Powered by</span><img src={`${import.meta.env.BASE_URL}leego-logo-transparent.png`} alt="Leego" width={20} height={20} style={{ width: 20, height: 20, objectFit: "contain" }} /></div><div><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></div></footer>
    </div>
  );
}
